...
const GeminiChat = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm Aswartha's AI assistant. Ask me anything about his skills, projects, or experience!",
      sender: 'ai',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        text: "I'm sorry, I'm having trouble connecting right now. Please try asking about Aswartha's skills, projects, or contact information!",
        sender: 'ai',
        timestamp: new Date()
      };
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs opacity-90">Ask about Aswartha's portfolio</p>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-4">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Ask me anything about Aswartha..."
